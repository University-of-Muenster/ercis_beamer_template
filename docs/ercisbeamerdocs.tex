...
\begin{table}[H]%
    \begin{center}%
        ...
        \begin{tabular}{>{\centering} m{2cm} >{\centering} m{2cm} >{\centering} m{2cm} >{\centering} m{2cm}}
            ...
            \tikz{\node [ratiobox, text width=15mm, minimum height=9.375mm] {16:10};} & \texttt{wide10} & 128 mm & 80 mm \tabularnewline
            \tikz{\node [ratiobox, text width=15mm, minimum height=8.4375mm] {16:9};} & \texttt{wide9} & 128 mm & 72 mm \tabularnewline
            \hline
        \end{tabular}
